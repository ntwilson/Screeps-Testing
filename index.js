...
(function($PS) {
  ...
  var Upgrader = (function () {
      ...
      Upgrader.value = new Upgrader();
      return Upgrader;
  })();
  var stringToCreepRole = function (roleString) {
      if (roleString === "Harvester") {
          return new Data_Maybe.Just(Harvester.value);
      };
      if (roleString === "Upgrader") {
          return new Data_Maybe.Just(Upgrader.value);
      };
      if (roleString === "Builder") {
          return new Data_Maybe.Just(Builder.value);
      };
  ...
  exports["stringToCreepRole"] = stringToCreepRole;
          ...
          if (v instanceof Data_Either.Right) {
              if (v.value0 === "true") {
                  ...
                  if (!v1) {
                      ...
                      throw new Error("Failed pattern match at Role.Builder (line 43, column 15 - line 50, column 33): " + [ v2.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Role.Builder (line 37, column 11 - line 50, column 33): " + [ v1.constructor.name ]);
              };
              if (v.value0 === "false") {
                  ...
                  if (!v1) {
                      ...
                      throw new Error("Failed pattern match at Role.Builder (line 57, column 15 - line 64, column 33): " + [ v2.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Role.Builder (line 52, column 11 - line 64, column 33): " + [ v1.constructor.name ]);
              };
              return Data_Unit.unit;
          };
          throw new Error("Failed pattern match at Role.Builder (line 31, column 3 - line 66, column 20): " + [ v.constructor.name ]);
      };
  };
...
(function($PS) {
  ...
  var runUpgrader = function (creep) {
      return function __do() {
          ...
          if (v instanceof Data_Either.Right) {
              if (v.value0 === "false") {
                  var $12 = Screeps_Creep.amtCarrying(creep)("energy") < Screeps_Creep.carryCapacity(creep);
                  if ($12) {
                      var v1 = Data_Array.head(Screeps_Room.find(Screeps_RoomObject.room(creep))(Screeps_Constants.find_sources));
                      if (v1 instanceof Data_Maybe.Nothing) {
                          return Data_Unit.unit;
                      };
                      if (v1 instanceof Data_Maybe.Just) {
                          var v2 = Screeps_Creep.harvestSource(creep)(v1.value0)();
                          var $15 = Data_Eq.eq(Screeps_Types.eqReturnCode)(v2)(Screeps_Constants.err_not_in_range);
                          if ($15) {
                              return ignoreM(Effect.monadEffect)(Screeps_Creep.moveTo(creep)(new Screeps_Types.TargetObj(v1.value0)))();
                          };
                      ...
                      throw new Error("Failed pattern match at Role.Upgrader (line 35, column 13 - line 42, column 31): " + [ v1.constructor.name ]);
                  };
                  return Screeps_Creep.setMemory(Data_Argonaut_Encode_Class.encodeJsonJString)(creep)("working")("\"true\"")();
              };
              if (v.value0 === "true") {
                  var v1 = Screeps_Game.getGameGlobal();
                  var $18 = Screeps_Creep.amtCarrying(creep)("energy") > 0;
                  if ($18) {
                      var v2 = Screeps_Room.controller(Screeps_RoomObject.room(creep));
                      if (v2 instanceof Data_Maybe.Nothing) {
                          return Data_Unit.unit;
                      };
                      if (v2 instanceof Data_Maybe.Just) {
                          var v3 = Screeps_Creep.upgradeController(creep)(v2.value0)();
                          var $21 = Data_Eq.eq(Screeps_Types.eqReturnCode)(v3)(Screeps_Constants.err_not_in_range);
                          if ($21) {
                              return ignoreM(Effect.monadEffect)(Screeps_Creep.moveTo(creep)(new Screeps_Types.TargetObj(v2.value0)))();
                          };
                          return Data_Unit.unit;
                      };
                      throw new Error("Failed pattern match at Role.Upgrader (line 48, column 13 - line 57, column 28): " + [ v2.constructor.name ]);
                  };
                  return Screeps_Creep.setMemory(Data_Argonaut_Encode_Class.encodeJsonJString)(creep)("working")("\"false\"")();
              };
              return Screeps_Creep.setMemory(Data_Argonaut_Encode_Class.encodeJsonJString)(creep)("working")("\"false\"")();
          };
          throw new Error("Failed pattern match at Role.Upgrader (line 28, column 3 - line 60, column 51): " + [ v.constructor.name ]);
      };
  };
...
(function($PS) {
  ...
  var createCreepInRole = function (spawn) {
      return function (parts) {
          return function (role) {
              var mem = (function () {
                  if (role instanceof Screeps_Types.Harvester) {
                      return {
                          role: "\"Harvester\""
                      };
                  };
                  if (role instanceof Screeps_Types.Builder) {
                      return {
                          role: "\"Builder\""
                      };
                  };
                  if (role instanceof Screeps_Types.Upgrader) {
                      return {
                          role: "\"Upgrader\""
                      };
                  };
                  throw new Error("Failed pattern match at Screeps.Spawn (line 66, column 7 - line 69, column 43): " + [ role.constructor.name ]);
              })();
              return createCreep$prime(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                  return "role";
              }))())())(spawn)(parts)(Data_Maybe.Nothing.value)(mem);
          };
      };
  };
  ...
  exports["createCreepInRole"] = createCreepInRole;
})(PS);
(function($PS) {
  "use strict";
  $PS["Main"] = $PS["Main"] || {};
  ...
  var runCreepRole = function (creep) {
      return function __do() {
          ...
          if (v instanceof Data_Either.Right) {
              var v1 = Screeps_Types.stringToCreepRole(v.value0);
              if (v1 instanceof Data_Maybe.Just) {
                  return matchUnit(creep)(v1.value0)();
              };
              if (v1 instanceof Data_Maybe.Nothing) {
                  return Data_Unit.unit;
              };
              throw new Error("Failed pattern match at Main (line 54, column 9 - line 56, column 34): " + [ v1.constructor.name ]);
          };
          if (v instanceof Data_Either.Left) {
              return Effect_Console.log(v.value0)();
          };
          throw new Error("Failed pattern match at Main (line 52, column 5 - line 58, column 14): " + [ v.constructor.name ]);
      };
  };
  var creepToRole = function (creep) {
      return function __do() {
          ...
          if (v instanceof Data_Either.Right) {
              return Screeps_Types.stringToCreepRole(v.value0);
          };
          throw new Error("Failed pattern match at Main (line 63, column 3 - line 65, column 63): " + [ v.constructor.name ]);
      };
  };
  var creepIsRole = function (creep) {
      return function (role) {
          return function __do() {
              ...
              if (v instanceof Data_Maybe.Just) {
                  if (role instanceof Screeps_Types.Harvester && v.value0 instanceof Screeps_Types.Harvester) {
                      return true;
                  };
                  if (role instanceof Screeps_Types.Upgrader && v.value0 instanceof Screeps_Types.Upgrader) {
                      return true;
                  };
                  if (role instanceof Screeps_Types.Builder && v.value0 instanceof Screeps_Types.Builder) {
                      return true;
                  };
                  return false;
              };
              ...
              throw new Error("Failed pattern match at Main (line 70, column 3 - line 77, column 26): " + [ v.constructor.name ]);
          };
      };
  };
  var spawnNewCreeps = function (creep) {
      return function __do() {
          ...
          var v1 = Foreign_Object.filter(function (n) {
              return Effect_Unsafe.unsafePerformEffect(creepIsRole(n)(Screeps_Types.Harvester.value));
          })(Screeps_Game.creeps(v));
          var v2 = Foreign_Object.filter(function (n) {
              return Effect_Unsafe.unsafePerformEffect(creepIsRole(n)(Screeps_Types.Upgrader.value));
          })(Screeps_Game.creeps(v));
          var v3 = Foreign_Object.filter(function (n) {
              return Effect_Unsafe.unsafePerformEffect(creepIsRole(n)(Screeps_Types.Builder.value));
          })(Screeps_Game.creeps(v));
          ...
          if (v4 instanceof Data_Maybe.Just) {
              var $36 = Foreign_Object.size(v1) < 5;
              if ($36) {
                  var v5 = Screeps_Spawn.createCreepInRole(v4.value0)([ Screeps_Constants.part_move, Screeps_Constants.part_work, Screeps_Constants.part_work, Screeps_Constants.part_carry ])(Screeps_Types.Harvester.value)();
                  ...
                  throw new Error("Failed pattern match at Main (line 97, column 13 - line 99, column 40): " + [ v5.constructor.name ]);
              };
              var $41 = Foreign_Object.size(v3) < 2;
              if ($41) {
                  var v5 = Screeps_Spawn.createCreepInRole(v4.value0)([ Screeps_Constants.part_move, Screeps_Constants.part_move, Screeps_Constants.part_work, Screeps_Constants.part_carry ])(Screeps_Types.Builder.value)();
                  if (v5 instanceof Data_Either.Right) {
                      return Effect_Class_Console.logShow(Effect_Class.monadEffectEffect)(Data_Show.showString)(v5.value0)();
                  };
                  if (v5 instanceof Data_Either.Left) {
                  ...
                  throw new Error("Failed pattern match at Main (line 103, column 15 - line 105, column 42): " + [ v5.constructor.name ]);
              };
              var v5 = Screeps_Spawn.createCreepInRole(v4.value0)([ Screeps_Constants.part_move, Screeps_Constants.part_work, Screeps_Constants.part_work, Screeps_Constants.part_carry ])(Screeps_Types.Upgrader.value)();
              if (v5 instanceof Data_Either.Right) {
                  return Effect_Class_Console.logShow(Effect_Class.monadEffectEffect)(Data_Show.showString)(v5.value0)();
              };
              if (v5 instanceof Data_Either.Left) {
              ...
              throw new Error("Failed pattern match at Main (line 108, column 15 - line 110, column 42): " + [ v5.constructor.name ]);
          };
          throw new Error("Failed pattern match at Main (line 92, column 7 - line 110, column 42): " + [ v4.constructor.name ]);
      };
  };
  var loop = function __do() {
      var v = Screeps_Game.getGameGlobal();
      (function () {
          var $52 = Foreign_Object.isEmpty(Screeps_Game.creeps(v));
          if ($52) {
      ...
      return Data_Foldable.for_(Effect.applicativeEffect)(Foreign_Object.foldableObject)(Screeps_Game.creeps(v))(function (n) {
          return function __do() {
              Data_Foldable.for_(Effect.applicativeEffect)(Foreign_Object.foldableObject)(Screeps_Game.spawns(v))(function (spawn) {
                  var $53 = Data_Eq.eq(Screeps_Types.eqReturnCode)(Screeps_Spawn.canCreateCreep(spawn)([ Screeps_Constants.part_move, Screeps_Constants.part_work, Screeps_Constants.part_work, Screeps_Constants.part_carry ]))(0);
                  if ($53) {
