...
(function($PS) {
  ...
  var runHarvester = function (creep) {
      ...
      if ($7) {
          ...
          throw new Error("Failed pattern match at Role.Harvester (line 27, column 5 - line 33, column 23): " + [ v.constructor.name ]);
      };
      return function __do() {
          var v = Screeps_Game.getGameGlobal();
          var v1 = Foreign_Object.lookup("Spawn1")(Screeps_Game.spawns(v));
          ...
          throw new Error("Failed pattern match at Role.Harvester (line 37, column 5 - line 43, column 23): " + [ v1.constructor.name ]);
      };
  };
...
(function($PS) {
  ...
  var runUpgrader = function (creep) {
      var $7 = Screeps_Creep.amtCarrying(creep)("energy") === 0;
      if ($7) {
          var v = Data_Array.head(Screeps_Room.find(Screeps_RoomObject.room(creep))(Screeps_Constants.find_sources));
          if (v instanceof Data_Maybe.Nothing) {
              return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
          ...
          throw new Error("Failed pattern match at Role.Upgrader (line 28, column 5 - line 34, column 23): " + [ v.constructor.name ]);
      };
      return function __do() {
          var v = Screeps_Game.getGameGlobal();
          ...
          throw new Error("Failed pattern match at Role.Upgrader (line 38, column 5 - line 44, column 23): " + [ v1.constructor.name ]);
      };
  };
...
(function($PS) {
  ...
  var Screeps_Creep = $PS["Screeps.Creep"];
  var Screeps_Game = $PS["Screeps.Game"];                
  var returnUnit = function (a) {
      return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
  };
  var matchUnit = function (creep) {
      return function (role) {
          var $4 = role === "harvester";
          if ($4) {
  ...
  var runCreepRole = function (creep) {
      return function __do() {
          ...
          return Data_Either.either(returnUnit)(matchUnit(creep))(v)();
      };
  };
