  ...
  var spawnNewCreeps = function (creep) {
      return function __do() {
          ...
          if (v4 instanceof Data_Maybe.Just) {
              ...
              if ($29) {
                  var v5 = Screeps_Spawn["createCreep'"](Data_Argonaut_Encode_Class.encodeJsonJString)(v4.value0)([ Screeps_Constants.part_move, Screeps_Constants.part_work, Screeps_Constants.part_work, Screeps_Constants.part_carry ])(Data_Maybe.Nothing.value)("{\"role\":\"Harvester\"}")();
                  ...
                  throw new Error("Failed pattern match at Main (line 88, column 13 - line 90, column 40): " + [ v5.constructor.name ]);
              };
              var $34 = Foreign_Object.size(v3) < 2;
              if ($34) {
                  var v5 = Screeps_Spawn["createCreep'"](Data_Argonaut_Encode_Class.encodeJsonJString)(v4.value0)([ Screeps_Constants.part_move, Screeps_Constants.part_move, Screeps_Constants.part_work, Screeps_Constants.part_carry ])(Data_Maybe.Nothing.value)("{\"role\":\"Builder\", \"Building\":\"false\"}")();
                  if (v5 instanceof Data_Either.Right) {
                      return Effect_Class_Console.logShow(Effect_Class.monadEffectEffect)(Data_Show.showString)(v5.value0)();
                  };
                  if (v5 instanceof Data_Either.Left) {
                  ...
                  throw new Error("Failed pattern match at Main (line 94, column 15 - line 96, column 42): " + [ v5.constructor.name ]);
              };
              var v5 = Screeps_Spawn["createCreep'"](Data_Argonaut_Encode_Class.encodeJsonJString)(v4.value0)([ Screeps_Constants.part_move, Screeps_Constants.part_work, Screeps_Constants.part_work, Screeps_Constants.part_carry ])(Data_Maybe.Nothing.value)("{{\"memory\": \"role\":\"Upgrader\"}}")();
              if (v5 instanceof Data_Either.Right) {
                  return Effect_Class_Console.logShow(Effect_Class.monadEffectEffect)(Data_Show.showString)(v5.value0)();
              };
              if (v5 instanceof Data_Either.Left) {
              ...
              throw new Error("Failed pattern match at Main (line 99, column 15 - line 101, column 42): " + [ v5.constructor.name ]);
          };
          throw new Error("Failed pattern match at Main (line 83, column 7 - line 101, column 42): " + [ v4.constructor.name ]);
      };
  };
      ...
      (function () {
          ...
          if ($45) {
              return Data_Foldable.for_(Effect.applicativeEffect)(Foreign_Object.foldableObject)(Screeps_Game.spawns(v))(function (spawn) {
                  return Screeps_Spawn["createCreep'"](Data_Argonaut_Encode_Class.encodeJsonJString)(spawn)([ Screeps_Constants.part_move, Screeps_Constants.part_move, Screeps_Constants.part_work, Screeps_Constants.part_carry ])(Data_Maybe.Nothing.value)("{{\"memory\": \"role\":\"Upgrader\"}}");
              })();
          };
          return Data_Unit.unit;
      })();
